...
public class ArtifactsExtension extends DefaultNamedDomainObjectSet<Artifact> implements Resolver<Artifact> {
    ...
    public NativeLibraryArtifact nativeLibraryArtifact(String name, final Action<NativeLibraryArtifact> config) {
        return artifact(name, NativeLibraryArtifact.class, config);
    }
